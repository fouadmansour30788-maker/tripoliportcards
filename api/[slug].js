...
<body>
  <div class="card">
    ...
    <a class="save-btn" href="/api/${slug}">Save Contact</a>
...
module.exports = (req, res) => {
  ...
  // ?view=page shows the styled info page instead of saving directly.
  // Default (no query string at all) goes straight to the vCard — this
  // keeps the printed QR code's URL as short as possible.
